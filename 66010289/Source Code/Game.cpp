...
void Game::initWindow()
{
	...
	this->window = new sf::RenderWindow(this->videoMode, "Just Beat and Shape!",   sf::Style::Close | sf::Style::Titlebar );
...
//Update player Game in Leader board
...
//Update when player collaspe with game object
//Damaging
//Heal
//Clear
